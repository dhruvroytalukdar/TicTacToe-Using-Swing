...
public class tic_tac_toe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("YOUR TIC TAC TOE GAME");
        ...
        jLabel3.setText("Enter the name of Player 1:");

        jLabel4.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel4.setText("Enter the name of Player 2:");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tictactoe/tttt.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            Gameplay obj = new Gameplay(jTextField1.getText(),jTextField2.getText());
            obj.setVisible(true);
            dispose();
        }
        else
